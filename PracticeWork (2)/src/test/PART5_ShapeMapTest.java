...
class PART5_ShapeMapTest {
	...
	@Test
	void testShapeMapCountNames() {

		assertEquals(0, map.countShapeOfName("Rectangle"), "ShapeMap.countShapeOfName() not working?");
		...
		assertEquals(4, map.countShapeOfName("Rectangle"), "ShapeMap.countShapeOfName() not working?");

		assertEquals(0, map.countShapeOfName("Circle"), "ShapeMap.countShapeOfName() not working?");
		assertEquals(5, map.addShape(new Circle("YELLOW")), "ShapeMap.addShape() not working correctly?");
		assertEquals(4, map.countShapeOfName("Rectangle"), "ShapeMap.countShapeOfName() not working?");
		assertEquals(1, map.countShapeOfName("Circle"), "ShapeMap.countShapeOfName() not working?");
		
		assertEquals(6, map.addShape(new Circle("RED")), "ShapeMap.addShape() not working correctly?");
		assertEquals(2, map.countShapeOfName("Circle"), "ShapeMap.countShapeOfName() not working?");
		assertEquals(0, map.countShapeOfName("Triangle"), "ShapeMap.countShapeOfName() not working?");

		try {
			assertEquals(0, map.countShapeOfName(null), "ShapeMap.countShapeOfName() not working?");
			assertEquals(0, map.countShapeOfName(""), "ShapeMap.countShapeOfName() not working?");

			assertEquals(4, map.countShapeOfName("rECTangle"),
					"ShapeMap.countShapeOfName() not working with mixed case?");
			assertEquals(2, map.countShapeOfName("circle"),
					"ShapeMap.countShapeOfName() not working with mixed case?");
			assertEquals(2, map.countShapeOfName("CIRCLE"),
					"ShapeMap.countShapeOfName() not working with mixed case?");

			assertEquals(7, map.addShape(new Rectangle("red")), "ShapeMap.addShape() not working correctly?");
			assertEquals(5, map.countShapeOfName("RectanglE"),
					"ShapeMap.countShapeOfName() not working with mixed case?");

		} catch (Exception e) {

			fail("ShapeMap.countShapeOfName() throwing an exception when null colour value passed, should return 0");
		}
	}
