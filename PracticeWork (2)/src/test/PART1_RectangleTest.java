...
class PART1_RectangleTest {
	...
	void testRectangleDefaultSize() {
		...
		assertEquals(10, r1.getHeight(),
				"Constructor or Rectangle.getHeight() not implemented correctly? 'height' should be 10");
		assertEquals(10, r1.getWidth(),
				"Constructor or Rectangle.getWidth() not implemented correctly? 'width' should be 10");
		
		assertEquals(100, r1.getArea(), "Constructor or Rectangle.getArea() not implemented correctly?");
	}
