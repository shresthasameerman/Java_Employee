...
class PART2_CircleTest {
	...
	void testCircleSides() {
		...
		assertEquals(1, c1.getSides(), "A Circular shape should have 1 side");

		Circle c2 = new Circle("BLUE", 2);
		assertEquals(1, c2.getSides(), "A Circular shape should have 1 side");

		Circle c3 = new Circle();
		assertEquals(1, c3.getSides(), "A Circular shape should have 1 side");
	}
	...
	@Test
	void testCircleHasLargerArea() {

		Circle c1 = new Circle("RED");

		c1.setRadius(10);
		assertTrue(c1.hasLargerArea(100), "Circle.hasLargerArea() not implemented correctly?");
		assertTrue(c1.hasLargerArea(-1), "Circle.hasLargerArea() not implemented correctly?");
		assertFalse(c1.hasLargerArea(315), "Circle.hasLargerArea() not implemented correctly?");
		assertTrue(c1.hasLargerArea(314), "Circle.hasLargerArea() not implemented correctly?");
		assertFalse(c1.hasLargerArea(1000), "Circle.hasLargerArea() not implemented correctly?");
	}

	@Test
	void testCircleHasSmallerArea() {

		Circle c1 = new Circle("RED");

		c1.setRadius(100);
		assertTrue(c1.hasSmallerArea(40000), "Circle.hasSmallerArea() not implemented correctly?");
		assertTrue(c1.hasSmallerArea(31420), "Circle.hasSmallerArea() not implemented correctly?");
		assertFalse(c1.hasSmallerArea(31410), "Circle.hasSmallerArea() not implemented correctly?");
		assertFalse(c1.hasSmallerArea(0), "Circle.hasSmallerArea() not implemented correctly?");
		assertFalse(c1.hasSmallerArea(-1), "Circle.hasSmallerArea() not implemented correctly?");
	}
