...
class PART4_ShapeListTest {
	...
	@Test
	void testShapeListCountNames() {

		assertEquals(0, list.countShapeOfName("Rectangle"), "ShapeList.countShapeOfName() not working?");
		...
		assertEquals(4, list.countShapeOfName("Rectangle"), "ShapeList.countShapeOfName() not working?");

		assertEquals(5, list.addShape(new Rectangle("YELLOW")), "ShapeList.addShape() not working correctly?");
		assertEquals(5, list.countShapeOfName("Rectangle"), "ShapeList.countShapeOfName() not working?");

		assertEquals(0, list.countShapeOfName("Circle"), "ShapeList.countShapeOfName() not working?");
		assertEquals(6, list.addShape(new Circle("RED")), "ShapeList.addShape() not working correctly?");
		assertEquals(1, list.countShapeOfName("Circle"), "ShapeList.countShapeOfName() not working?");
		assertEquals(0, list.countShapeOfName("Triangle"), "ShapeList.countShapeOfName() not working?");
		
		assertEquals(7, list.addShape(new Circle("RED")), "ShapeList.addShape() not working correctly?");
		assertEquals(8, list.addShape(new RightTriangle("RED")), "ShapeList.addShape() not working correctly?");
		assertEquals(9, list.addShape(new Rectangle("YELLOW")), "ShapeList.addShape() not working correctly?");
		assertEquals(2, list.countShapeOfName("Circle"), "ShapeList.countShapeOfName() not working?");
		assertEquals(1, list.countShapeOfName("Triangle"), "ShapeList.countShapeOfName() not working?");
		assertEquals(6, list.countShapeOfName("Rectangle"), "ShapeList.countShapeOfName() not working?");
	}

	@Test
	void testShapeListCountNamesAdvanced() {

		try {
			assertEquals(0, list.countShapeOfName(null), "ShapeList.countShapeOfName() not working?");
			assertEquals(0, list.countShapeOfName(""), "ShapeList.countShapeOfName() not working?");
			...
			assertEquals(3, list.addShape(new Rectangle("PINK")), "ShapeList.addShape() not working correctly?");
			assertEquals(4, list.addShape(new RightTriangle("PINK", 10, 10)), "ShapeList.addShape() not working correctly?");
			
			assertEquals(3, list.countShapeOfName("RECTangle"),
					"ShapeList.countShapeOfName() not working with mixed case?");
			assertEquals(1, list.countShapeOfName("triangle"),
					"ShapeList.countShapeOfName() not working with mixed case?");
			assertEquals(1, list.countShapeOfName("TriAngle"),
					"ShapeList.countShapeOfName() not working with mixed case?");

			assertEquals(5, list.addShape(new Rectangle("red")), "ShapeList.addShape() not working correctly?");
			assertEquals(4, list.countShapeOfName("RectanglE"),
					"ShapeList.countShapeOfName() not working with mixed case?");

		} catch (Exception e) {

			fail("ShapeList.countShapeOfName() throwing an exception when null colour value passed, should return 0");
		}
	}
}
